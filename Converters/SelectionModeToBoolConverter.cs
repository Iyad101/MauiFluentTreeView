// SelectionModeToBoolConverter.cs
#region Usings
...
namespace MauiFluentTreeView.Converters
{
    ...
    /// Returns true if the mode is <see cref="TreeSelectionMode.Multiple"/>, otherwise false.
    /// </summary>
    public class SelectionModeToBoolConverter : IValueConverter
    {
        #region IValueConverter Implementation
        /// <summary>
        /// Converts a <see cref="TreeSelectionMode"/> value to a boolean.
        /// </summary>
        ...
        /// <returns>True if the selection mode is <see cref="TreeSelectionMode.Multiple"/>, otherwise false.</returns>
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            Debug.WriteLine($"SelectionModeToBoolConverter received: {value}");
            if (value is TreeSelectionMode mode)
            {
                if (mode == TreeSelectionMode.Multiple)
                {
                    return true;
                }
                else
